...
L’état local et ses preuves font foi : ne réinitialiser aucun lot ni `registry/state.json` lors d’une adoption documentaire. Après L05-C validé, L05-D adopte et requalifie le plan 1.2. La révision 1.3 ajoute L19, exclusivement documentaire pour le futur mod animalier, et L20, strictement postérieur à V1 : aucun travail L20/T20 ne bloque ni ne requalifie ISRWorldGen 1.0.0. Les contrats C08–C12 sont des modèles internes versionnés, jamais des API Vintage Story supposées ; conserver les projets existants et ne renommer aucun chemin sans migration explicite.
