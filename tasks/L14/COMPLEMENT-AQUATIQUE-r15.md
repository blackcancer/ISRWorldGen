# L14 — Nature du fond géologique

**Complément 1.5 des missions L14-B, L14-C ; ni remplacement de leurs anciens critères ni nouvelle tâche.**

## Objectif et travail

L14-B/C fournit les données de roche/formation/dépôt déjà prévues et leur projection comme fond géologique. Ne pas recalculer une géologie marine séparée pour la végétation. Conserver les versions et distinguer roche de référence, dépôt de surface et modifications locales du support par un peuplement.

La qualification complémentaire s’effectue avec les fixtures T-AQ-03/04/08 par leurs propriétaires ; les producteurs n’attendent jamais L19. Aucun nouveau sous-lot de géologie ni matériau natif fictif.
